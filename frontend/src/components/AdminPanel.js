            ...
            <div className="bg-white dark:bg-[#2d2640] w-full sm:max-w-lg sm:rounded-2xl overflow-hidden shadow-2xl animate-slideIn">
              ...
              <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-5">
                ...
                <div>
                  ...
                  {/* Existing + New Images Grid - MÁS GRANDE (60%) y botones pequeños */}
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-3">
                      {existingImages.map((image, idx) => (
                        ...
                        >
                          ...
                          {/* Overlay con botones EXTRA PEQUEÑOS */}
                              ...
                              <div className="flex flex-col items-center gap-1.5 pointer-events-auto">
                                ...
                                <div className="flex gap-1.5">
                                  <button
                                    ...
                                    className="w-8 h-8 bg-white hover:bg-gray-100 text-gray-800 rounded-full transition-all flex items-center justify-center shadow-lg hover:scale-110 active:scale-95 touch-manipulation"
                                    title="Ver imagen"
                                  >
                                  ...
                                  <button
                                    ...
                                    className="w-8 h-8 bg-purple-500 hover:bg-purple-600 text-white rounded-full transition-all flex items-center justify-center shadow-lg hover:scale-110 active:scale-95 touch-manipulation"
                                ...
                                {/* Fila inferior: 1 botón centrado */}
                                <button
                                  type="button"
                                  onClick={(e) => {
                                    e.stopPropagation();
                                  ...
                                  className="w-8 h-8 bg-red-500 hover:bg-red-600 text-white rounded-full transition-all flex items-center justify-center shadow-lg hover:scale-110 active:scale-95 touch-manipulation"
                        ...
                        >
                          ...
                          <div className="absolute inset-0 bg-black/80 opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center pointer-events-none">
                            <button
                              ...
                              className="w-8 h-8 bg-red-500 hover:bg-red-600 text-white rounded-full transition-all flex items-center justify-center shadow-lg hover:scale-110 active:scale-95 touch-manipulation pointer-events-auto"
                              title="Eliminar"
                            >
                              <Trash2 className="w-3.5 h-3.5" strokeWidth={2.5} />
                            </button>
